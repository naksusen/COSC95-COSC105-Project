...
<head>
  ...
  <title>CSG ELECTIONS MITING DE AVANCE</title>
    ...
    <div class="grid grid-cols-2 gap-16 mt-20">
      <div>
        <div class="px-20 ml-10">
          <h2 class="text-center text-[80px] pb-2">CSG ELECTIONS</h2>
          <p class="text-justify pb-4 indent-8">
          𝐂𝐚𝐥𝐥𝐢𝐧𝐠 𝐚𝐥𝐥, 𝐂𝐯𝐬𝐮𝐞ñ𝐨𝐬!🗣️ 
          We are highly encouraging you to join us at 2024 Central Student Government's 
          Miting de Avance, where you'll have the chance to hear the platforms and visions 
          from our student leaders, engage in meaningful discussions, and shape the future 
          of our university. 
          </p>
      ...
      <div>
        <img src="images/CSG Elections.jpg" alt="" class="h-[650px] w-[650px] ml-4 ">
      </div>
    </div>
